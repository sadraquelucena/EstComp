...
- Como os valores da distribuição beta estão definidos no intervalo $(0,1)$, vamos usar a distribuiçao
$U(0, 1)$ como distribuição auxiliar. Logo, $g = 1$, $0 < x < 1$.
...
Assim, o algoritmo para gerar ocorrẽncias da beta($2.7, 6.3$) a partir da $U(0, 1)$ é:
